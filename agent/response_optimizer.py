...
from agent.prompt_optimizer import OptimizedGoal, PromptOptimizer
...
def main():
    ...
    parser.add_argument(
        "--task", type=str, required=True, help="実行するタスク"
    )
    ...
    optimized_response = response_optimizer.run(query=optimised_goal.text)
